...
class AlunoData:
    ...
    def update(self, aluno: Aluno):
        try:
            ...
            self.cursor.execute(sql, (aluno.nome, aluno.nome, aluno.idade, aluno.curso, aluno.matricula))
            self.conexao.commit()
        except Exception as error:
...
if __name__ == '__main__':
    a = AlunoData()
    a.delete('121eb2d8-96be-4567-8db5-dc46e2db0c4e')
    print(a.select())
